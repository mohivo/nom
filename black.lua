...
if Redis:get(black.."ch@Source_hivosource") then
chsource = Redis:get(black.."chsource")
else
chsource = "Source_hivo"
end
...
send(msg.chat_id,msg.id,"➢ مرحبا عزيزي في مصنع الحمايه المجاني لسورس 𝐇𝐈𝐕𝐎 \n➢ مبرمج السورس @hivo_dev","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
----
if text == 'المطور هيفو' or text == 'مبرمج السورس' or text == 'هيفو' then  
local UserId_Info = LuaTele.searchPublicChat("hivo_dev")
...
{
{text = '𝐇𝐈𝐕𝐎', url = "https://t.me/Source_hivo"}
},
}
...
{
{text = '𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎 ', url = "https://t.me/Source_hivo"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/Source_hivo/4"
local T =[[
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
 ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎 ❍
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 𝐇𝐈𝐕𝐎 .](t.me/hivo_dev)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ـــ❍ >> [˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎.](t.me/Source_hivo)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ِّّ𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎', url = 't.me/Source_hivo'}, 
},
}
